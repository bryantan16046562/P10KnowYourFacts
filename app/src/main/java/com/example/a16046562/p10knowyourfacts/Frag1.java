...
public class Frag1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tv1 = (TextView) view.findViewById(R.id.tv1frag1);
        tv2 = (TextView) view.findViewById(R.id.tv2frag1);
        tv3 = (TextView) view.findViewById(R.id.tv3frag1);
        btnchangecolor1 = (Button) view.findViewById(R.id.btnChangeColor);
